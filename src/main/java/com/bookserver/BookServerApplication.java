...
@SpringBootApplication(scanBasePackages = BookServerApplication.BASE_PACKAGE)
@EnableSwagger2
public class BookServerApplication {
    ...
    static final String BASE_PACKAGE = "com.bookserver";

    private static final String CONTROLLER_PACKAGE = "com.bookserver.controller";
